 ...
 */
const LinkMain: React.FC<LinkMainProps> = ({ url, isUrlValid, setUrl, setLink, removeLink, openLink, isActive }) => {
        ...
        <CardItemGroup orientation="horizontal">
          ...
          <ButtonGroup>
            <Button
              ...
              onClick={setLink}
              title="Apply link"
              disabled={(!url && !isActive) || !isUrlValid}
              variant="ghost"
            >
...
export const LinkPopover = forwardRef<HTMLButtonElement, LinkPopoverProps>(
  (
    ...
    const { isVisible, canSet, isActive, url, isUrlValid, setUrl, setLink, removeLink, openLink, label, Icon } =
      useLinkPopover({
        editor,
        hideWhenUnavailable,
        onSetLink,
