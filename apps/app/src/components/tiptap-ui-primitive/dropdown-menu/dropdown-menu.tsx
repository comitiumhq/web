...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn('tiptap-dropdown-menu-item cursor-pointer', className)}
      {...props}
    />
  );
}
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn('tiptap-dropdown-menu-checkbox-item cursor-pointer', className)}
      checked={checked}
      {...props}
    >
...
function DropdownMenuRadioItem({
  ...
  return (
    <DropdownMenuPrimitive.RadioItem
      ...
      data-inset={inset}
      className={cn('tiptap-dropdown-menu-radio-item cursor-pointer', className)}
      {...props}
    >
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn('tiptap-dropdown-menu-sub-trigger cursor-pointer', className)}
      {...props}
    >
      {children}
    </DropdownMenuPrimitive.SubTrigger>
