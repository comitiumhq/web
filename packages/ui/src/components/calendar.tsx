    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          {
            '[&:first-child[data-selected=true]_button]:rounded-l-(--cell-radius)': !props.showWeekNumber,
            '[&:nth-child(2)[data-selected=true]_button]:rounded-l-(--cell-radius)': props.showWeekNumber,
          },
