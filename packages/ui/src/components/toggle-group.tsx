    ...
    <ToggleGroupPrimitive.Item
      ...
      className={cn(
        ...
        resolvedVariant === 'outline'
          ? 'data-[state=on]:border-control-border-hover data-[state=on]:bg-segment data-[state=on]:text-foreground data-[state=on]:shadow-[var(--segment-shadow)] data-[state=on]:hover:bg-segment'
